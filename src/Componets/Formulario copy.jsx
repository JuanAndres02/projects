                    ...
                    <Formik initialValues={{
                        ...
                        validate={(valores) => {
                            ...
                            */
                            ...
                            if (nivelSuperior && !valores.nombreInstitucionAcademica) {
                                errores.nombreInstitucionAcademica = 'Porfavor ingrese el nombre de la instituion academica'
                            } 
                        ...
                        render = {({ values, errors, validateForm, touched, handleBlur}) => (
                            <Form>
                                                    ...
                                                    <div className="col minicomponete">
                                                        {
                                                            <label htmlFor="nivelAcademicoId"> Nivel academico
                                                                <select component={Input} defaultValue={0} name="nivelAcademicoId" className="form-select mt-3" onChange={(e) => { cambiarNivel(e) }} aria-label="Default select example"  >
                                            ...
                                            <div className="row ">
                                                <div className=" col minicomponete">
                                                    <label className='mt-3' htmlFor="OtraInstitucionVoluntariosHaPertenecido">  En otra institucion ha pertenecido como voluntario
                                                        <Field className="form-check " type="checkbox" id="OtraInstitucionVoluntariosHaPertenecido"></Field>
